...
class EarnHTTP(_AsyncV5HTTPManager):
    async def get_earn_product_info(self, **kwargs):
        """
        Required args:
    ...
    async def stake_or_redeem(self, **kwargs):
        """
        Required args:
            category (string): FlexibleSaving
    ...
    async def get_stake_or_redemption_history(self, **kwargs):
        """
        Required args:
            category (string): FlexibleSaving
    ...
    async def get_staked_position(self, **kwargs):
        """
        Required args:
            category (string): FlexibleSaving
