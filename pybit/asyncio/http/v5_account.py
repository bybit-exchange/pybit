...
class AsyncAccountHTTP(AsyncClient):
    ...
    async def get_transferable_amount(self, **kwargs) -> dict:
    ...
    async def upgrade_to_unified_trading_account(self, **kwargs) -> dict:
    ...
    async def repay_liability(self, **kwargs) -> dict:
    ...
    async def set_collateral_coin(self, **kwargs) -> dict:
    ...
    async def batch_set_collateral_coin(self, **kwargs) -> dict:
        """You can decide whether the assets in the Unified account needs to be collateral coins.
    ...
    async def get_fee_rates(self, **kwargs) -> dict:
    ...
    async def get_account_info(self, **kwargs) -> dict:
    ...
    async def get_contract_transaction_log(self, **kwargs) -> dict:
    ...
    async def set_margin_mode(self, **kwargs) -> dict:
    ...
    async def set_mmp(self, **kwargs) -> dict:
        """
    ...
    async def reset_mmp(self, **kwargs) -> dict:
    ...
    async def get_mmp_state(self, **kwargs) -> dict:
        """Get MMP state
    ...
    async def repay(self, **kwargs) -> dict:
    ...
    async def query_dcp_info(self, **kwargs) -> dict:
    ...
    async def get_smp_group(self, **kwargs) -> dict:
    ...
    async def get_user_setting_config(self):
    ...
    async def set_limit_price_action(self, **kwargs) -> dict:
