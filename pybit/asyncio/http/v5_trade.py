...
class AsyncTradeHTTP(AsyncClient):
    ...
    async def place_batch_order(self, **kwargs) -> dict:
    ...
    async def amend_batch_order(self, **kwargs) -> dict:
        """Covers: Option (Unified Account)
    ...
    async def cancel_batch_order(self, **kwargs) -> dict:
    ...
    async def get_borrow_quota(self, **kwargs) -> dict:
    ...
    async def set_dcp(self, **kwargs) -> dict:
        """Covers: Option (Unified Account)
    ...
    async def pre_check_order(self, **kwargs):
