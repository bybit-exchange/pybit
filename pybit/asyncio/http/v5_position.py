...
from pybit.position import Position


class AsyncPositionHTTP(AsyncClient):
    ...
    async def switch_margin_mode(self, **kwargs) -> dict:
    ...
    async def set_tp_sl_mode(self, **kwargs) -> dict:
    ...
    async def switch_position_mode(self, **kwargs) -> dict:
        """
    ...
    async def set_risk_limit(self, **kwargs) -> dict:
        """
    ...
    async def set_trading_stop(self, **kwargs) -> dict:
    ...
    async def set_auto_add_margin(self, **kwargs) -> dict:
    ...
    async def add_or_reduce_margin(self, **kwargs) -> dict:
    ...
    async def get_executions(self, **kwargs) -> dict:
    ...
    async def get_closed_pnl(self, **kwargs) -> dict:
