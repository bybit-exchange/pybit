...
class AsyncSpotLeverageHTTP(AsyncClient):
    async def get_leveraged_token_info(self, **kwargs) -> dict:
    ...
    async def get_leveraged_token_market(self, **kwargs) -> dict:
    ...
    async def purchase_leveraged_token(self, **kwargs) -> dict:
    ...
    async def redeem_leveraged_token(self, **kwargs) -> dict:
    ...
    async def get_purchase_redemption_records(self, **kwargs) -> dict:
