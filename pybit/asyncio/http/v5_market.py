...
class AsyncMarketHTTP(AsyncClient):
    ...
    async def get_mark_price_kline(self, **kwargs) -> dict:
    ...
    async def get_index_price_kline(self, **kwargs) -> dict:
    ...
    async def get_premium_index_price_kline(self, **kwargs) -> dict:
    ...
    async def get_tickers(self, **kwargs) -> dict:
    ...
    async def get_funding_rate_history(self, **kwargs) -> dict:
        """
    ...
    async def get_public_trade_history(self, **kwargs) -> dict:
    ...
    async def get_open_interest(self, **kwargs) -> dict:
    ...
    async def get_historical_volatility(self, **kwargs) -> dict:
    ...
    async def get_insurance(self, **kwargs) -> dict:
        """
    ...
    async def get_risk_limit(self, **kwargs) -> dict:
    ...
    async def get_option_delivery_price(self, **kwargs) -> dict:
    ...
    async def get_long_short_ratio(self, **kwargs) -> dict:
        """
        Required args:
